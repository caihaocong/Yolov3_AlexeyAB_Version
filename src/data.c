...
{
//	printf("----CH_CONG_20190827---- load_data_seg begin -- \n");
    ...
    for(i = 0; i < n; ++i){
        ...
        //show_image(sized_m, "part", 0);  //CH_CONG_20190827
...
void *load_thread(void *ptr)
{
    ...
    } else if (a.type == ISEG_DATA){           //CH_CONG_20190824
    ...
    } else if (a.type == INSTANCE_DATA){       //CH_CONG_20190824
    ...
    } else if (a.type == SEGMENTATION_DATA){   //CH_CONG_20190824
