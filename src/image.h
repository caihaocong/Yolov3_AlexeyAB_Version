...
#define TWO_PI 6.2831853071795864769252866f   //CH_CONG_20190824
...
augment_args random_augment_args(image im, float angle, float aspect, int low, int high, int w, int h);  //CH_CONG_20190824
